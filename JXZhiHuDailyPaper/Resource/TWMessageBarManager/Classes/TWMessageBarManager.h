...
#define ErrorTitle(title)  [NSError errorWithDomain:title code:0 userInfo:nil]

#define JXSuccess(message) [TWMessageBarManager.sharedInstance showMessageWithTitle:JX_ALERT_TITLE description:message type:TWMessageBarMessageTypeSuccess statusBarStyle:UIStatusBarStyleLightContent callback:NULL]
#define JXError(message)   [TWMessageBarManager.sharedInstance showMessageWithTitle:JX_ALERT_TITLE description:message type:TWMessageBarMessageTypeError statusBarStyle:UIStatusBarStyleLightContent callback:NULL]
#define JXInfo(message)    [TWMessageBarManager.sharedInstance showMessageWithTitle:JX_ALERT_TITLE description:message type:TWMessageBarMessageTypeInfo statusBarStyle:UIStatusBarStyleLightContent callback:NULL]
